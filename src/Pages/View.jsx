...
function View() {
 ...
 const [product,setProduct]=useState({})
  ...
  return (
    <>
    <Header/>
    <div style={{marginTop:'150px',height:'70vh'}} className='container'>
      <div className='row mb-5 align-items-center'>
        <div className="col-lg-1"></div>
        <div className='col-lg-4'>
          <img width={'400px'} height={'500px'} className='img-fluid' src={product?.thumbnail} alt="" />
        ...
        <div className='col-lg-6'>
          ...
          <h1>{product?.title}</h1>
          <h3 className='tex-primary fw-bolder'>${product?.price}</h3>
          <p style={{textAlign:'justify'}}><b>Description</b>: {product?.description}</p>
          <div className="d-flex justify-content-between">
            <button onClick={()=>handleWishlist(product)} className='btn btn-outline-dark'><i className="fa-solid fa-heart tex-primary"></i>
